...
func TestPopulateExpAssetStat(t *testing.T) {
	...
	assert.Equal(t, "100000000000000.000000", res.Balances.Authorized)
	assert.Equal(t, "50000000000000.000000", res.Balances.AuthorizedToMaintainLiabilities)
	assert.Equal(t, "2500000000000.000000", res.Balances.Unauthorized)
	assert.Equal(t, "1200000000000.000000", res.ClaimableBalancesAmount)
	assert.Equal(t, "7700000000000.000000", res.LiquidityPoolsAmount)
	assert.Equal(t, "900000000000.000000", res.ContractsAmount)
	assert.Equal(t, "100000000000000.000000", res.Amount)
	assert.Equal(t, int32(429), res.NumAccounts)
	assert.Equal(t, orbitr.AccountFlags{}, res.Flags)
