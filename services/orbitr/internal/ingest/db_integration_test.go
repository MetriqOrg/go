...
func (s *DBTestSuite) SetupTest() {
	s.tt = test.Start(s.T())
	test.ResetOrbitRDB(s.T(), s.tt.OrbitRDB)
	...
	// go test -v -timeout 5m --tags=update  github.com/metriqorg/go/services/orbitr/internal/ingest -run "^(TestUpdateSampleChanges)$"
	...
	sIface, err := NewSystem(Config{
		...
		HistorySession:           s.tt.OrbitRSession(),
