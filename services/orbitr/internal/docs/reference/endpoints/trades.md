...
```sh
curl https://orbitr.metriq.network/trades?base_asset_type=native&counter_asset_code=SLT&counter_asset_issuer=GCKA6K5PCQ6PNF5RQBF7PQDJWRHO6UOGFMRLK3DYHDOI244V47XKQ4GP&counter_asset_type=credit_alphanum4&limit=2&order=desc
```
...
```json
{
  "_links": {
    "self": {
      "href": "https://orbitr-testnet.metriq.network/trades?cursor=&limit=10&order=asc"
    },
    "next": {
      "href": "https://orbitr-testnet.metriq.network/trades?cursor=6025839120434-0&limit=10&order=asc"
    },
    "prev": {
      "href": "https://orbitr-testnet.metriq.network/trades?cursor=6012954218535-0&limit=10&order=desc"
    }
  },
  "_embedded": {
    "records": [
      {
        "_links": {
          ...
          "operation": {
            "href": "https://orbitr-testnet.metriq.network/operations/6012954218535"
          }
        },
        "id": "6012954218535-0",
      ...
      },
      {
        "_links": {
          ...
          "operation": {
            "href": "https://orbitr-testnet.metriq.network/operations/6025839120385"
          }
        },
        "id": "6025839120385-0",
