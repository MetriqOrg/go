...
func TestAssetStats(t *testing.T) {
	...
	usdAssetStatResponse := orbitr.AssetStat{
		...
		Balances: orbitr.AssetStatBalances{
			Authorized:                      "0.000001",
			AuthorizedToMaintainLiabilities: "0.000002",
			Unauthorized:                    "0.000003",
		},
		ClaimableBalancesAmount: "0.000010",
		LiquidityPoolsAmount:    "0.000020",
		Amount:                  "0.000001",
		NumAccounts:             usdAssetStat.NumAccounts,
		ContractsAmount:         "0.000000",
		Asset: base.Asset{
	...
	etherAssetStatResponse := orbitr.AssetStat{
		...
		Balances: orbitr.AssetStatBalances{
			Authorized:                      "0.000023",
			AuthorizedToMaintainLiabilities: "0.000046",
			Unauthorized:                    "0.000092",
		},
		ClaimableBalancesAmount: "0.000000",
		LiquidityPoolsAmount:    "0.000000",
		ContractsAmount:         "0.000000",
		Amount:                  "0.0000023",
	...
	eurAssetStatResponse := orbitr.AssetStat{
		...
		Balances: orbitr.AssetStatBalances{
			Authorized:                      "0.000111",
			AuthorizedToMaintainLiabilities: "0.000222",
			Unauthorized:                    "0.000333",
		},
		ClaimableBalancesAmount: "0.000000",
		LiquidityPoolsAmount:    "0.000000",
		Amount:                  "0.000111",
