// Package txsub provides the machinery that orbitr uses to submit transactions to
// the lantah network and track their progress.  It also helps to hide some of the
