...
import (
	...
	demo "github.com/metriqorg/go/txnbuild/cmd/demo/operations"
)
...
var txerrorCmd = &cobra.Command{
	...
	Long:  `This command submits an invalid transaction, in order to demonstrate a OrbitR error return.`,
