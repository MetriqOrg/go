...
func TestNextOperationsPage(t *testing.T) {
	...
	hmock.On(
		"GET",
		"https://orbitr-testnet.metriq.network/operations?cursor=661424967682&limit=2&order=asc",
...
var operationStreamResponse = `data: {"_links":{"self":{"href":"https://orbitr-testnet.metriq.network/operations/4934917427201"},"transaction":{"href":"https://orbitr-testnet.metriq.network/transactions/1c1449106a54cccd8a2ec2094815ad9db30ae54c69c3309dd08d13fdb8c749de"},"effects":{"href":"https://orbitr-testnet.metriq.network/operations/4934917427201/effects"},"succeeds":{"href":"https://orbitr-testnet.metriq.network/effects?order=desc\u0026cursor=4934917427201"},"precedes":{"href":"https://orbitr-testnet.metriq.network/effects?order=asc\u0026cursor=4934917427201"}},"id":"4934917427201","paging_token":"4934917427201","transaction_successful":true,"source_account":"GAIH3ULLFQ4DGSECF2AR555KZ4KNDGEKN4AFI4SU2M7B43MGK3QJZNSR","type":"create_account","type_i":0,"created_at":"2019-02-27T11:32:39Z","transaction_hash":"1c1449106a54cccd8a2ec2094815ad9db30ae54c69c3309dd08d13fdb8c749de","starting_balance":"10000.000000","funder":"GAIH3ULLFQ4DGSECF2AR555KZ4KNDGEKN4AFI4SU2M7B43MGK3QJZNSR","account":"GDBLBBDIUULY3HGIKXNK6WVBISY7DCNCDA45EL7NTXWX5R4UZ26HGMGS"}
`

var firstOperationsPage = `{
  "_links": {
    "self": {
      "href": "https://orbitr-testnet.metriq.network/operations?cursor=&limit=2&order=asc"
    },
    "next": {
      "href": "https://orbitr-testnet.metriq.network/operations?cursor=661424967682&limit=2&order=asc"
    },
    "prev": {
      "href": "https://orbitr-testnet.metriq.network/operations?cursor=661424967681&limit=2&order=desc"
    }
  },
  "_embedded": {
    "records": [
      {	
        "_links": {
          "self": {
            "href": "https://orbitr-testnet.metriq.network/operations/661424967681"
          },
          "transaction": {
            "href": "https://orbitr-testnet.metriq.network/transactions/749e4f8933221b9942ef38a02856803f379789ec8d971f1f60535db70135673e"
          },
          "effects": {
            "href": "https://orbitr-testnet.metriq.network/operations/661424967681/effects"
          },
          "succeeds": {
            "href": "https://orbitr-testnet.metriq.network/effects?order=desc&cursor=661424967681"
          },
          "precedes": {
            "href": "https://orbitr-testnet.metriq.network/effects?order=asc&cursor=661424967681"
          }
        },
        "id": "661424967681",
      ...
      },
      {
        "_links": {
          "self": {
            "href": "https://orbitr-testnet.metriq.network/operations/661424967682"
          },
          "transaction": {
            "href": "https://orbitr-testnet.metriq.network/transactions/749e4f8933221b9942ef38a02856803f379789ec8d971f1f60535db70135673e"
          },
          "effects": {
            "href": "https://orbitr-testnet.metriq.network/operations/661424967682/effects"
          },
          "succeeds": {
            "href": "https://orbitr-testnet.metriq.network/effects?order=desc&cursor=661424967682"
          },
          "precedes": {
            "href": "https://orbitr-testnet.metriq.network/effects?order=asc&cursor=661424967682"
          }
        },
        "id": "661424967682",
...
var emptyOperationsPage = `{
  "_links": {
    ...
    "next": {
      "href": "https://orbitr-testnet.metriq.network/operations?cursor=661424967684&limit=2&order=asc"
    },
    "prev": {
      "href": "https://orbitr-testnet.metriq.network/operations?cursor=661424967683&limit=2&order=desc"
    }
  },
  "_embedded": {
    "records": []
	  ...
	  "records": [
		{
			"_links": {
			  "self": {
				"href": "https://orbitr-testnet.metriq.network/operations/972702718365697"
			  },
			  "transaction": {
				"href": "https://orbitr-testnet.metriq.network/transactions/cfe9eba317025dd0cff111967a3709358153e9ee97472e67c17e42837dd50a52"
			  },
			  "effects": {
				"href": "https://orbitr-testnet.metriq.network/operations/972702718365697/effects"
			  },
			  "succeeds": {
				"href": "https://orbitr-testnet.metriq.network/effects?order=desc\u0026cursor=972702718365697"
			  },
			  "precedes": {
				"href": "https://orbitr-testnet.metriq.network/effects?order=asc\u0026cursor=972702718365697"
			  }
			},
			"id": "972702718365697",
		  ...
		  },
		  {
			"_links": {
			  "self": {
				"href": "https://orbitr-testnet.metriq.network/operations/158041911595009"
			  },
			  "transaction": {
				"href": "https://orbitr-testnet.metriq.network/transactions/8a4db87e4749130ba32924943c2f219de497fe2d4f3e074187c5d2159ca2d134"
			  },
			  "effects": {
				"href": "https://orbitr-testnet.metriq.network/operations/158041911595009/effects"
			  },
			  "succeeds": {
				"href": "https://orbitr-testnet.metriq.network/effects?order=desc&cursor=158041911595009"
			  },
			  "precedes": {
				"href": "https://orbitr-testnet.metriq.network/effects?order=asc&cursor=158041911595009"
			  }
			},
			"id": "158041911595009",
