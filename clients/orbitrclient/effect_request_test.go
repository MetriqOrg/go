...
func TestNextEffectsPage(t *testing.T) {
	...
	hmock.On(
		"GET",
		"https://orbitr-testnet.metriq.network/accounts/GCDIZFWLOTBWHTPODXCBH6XNXPFMSQFRVIDRP3JLEKQZN66G7NF3ANOD/effects?cursor=1557363731492865-3&limit=10&order=asc",
...
var effectStreamResponse = `data: {"_links":{"operation":{"href":"https://orbitr-testnet.metriq.network/operations/2531135896703017"},"succeeds":{"href":"https://orbitr-testnet.metriq.network/effects?order=desc\u0026cursor=2531135896703017-1"},"precedes":{"href":"https://orbitr-testnet.metriq.network/effects?order=asc\u0026cursor=2531135896703017-1"}},"id":"0002531135896703017-0000000001","paging_token":"2531135896703017-1","account":"GBNZN27NAOHRJRCMHQF2ZN2F6TAPVEWKJIGZIRNKIADWIS2HDENIS6CI","type":"account_credited","type_i":2,"created_at":"2019-04-03T10:14:17Z","asset_type":"credit_alphanum4","asset_code":"qwop","asset_issuer":"GBM4HXXNDBWWQBXOL4QCTZIUQAP6XFUI3FPINUGUPBMULMTEHJPIKX6T","amount":"0.0460000"}
`

var firstEffectsPage = `{
  "_links": {
    "self": {
      "href": "https://orbitr-testnet.metriq.network/accounts/GCDIZFWLOTBWHTPODXCBH6XNXPFMSQFRVIDRP3JLEKQZN66G7NF3ANOD/effects?cursor=&limit=10&order=asc"
    },
    "next": {
      "href": "https://orbitr-testnet.metriq.network/accounts/GCDIZFWLOTBWHTPODXCBH6XNXPFMSQFRVIDRP3JLEKQZN66G7NF3ANOD/effects?cursor=1557363731492865-3&limit=10&order=asc"
    },
    "prev": {
      "href": "https://orbitr-testnet.metriq.network/accounts/GCDIZFWLOTBWHTPODXCBH6XNXPFMSQFRVIDRP3JLEKQZN66G7NF3ANOD/effects?cursor=1557363731492865-1&limit=10&order=desc"
    }
  },
  "_embedded": {
    "records": [
      {
        "_links": {
          "operation": {
            "href": "https://orbitr-testnet.metriq.network/operations/1557363731492865"
          },
          "succeeds": {
            "href": "https://orbitr-testnet.metriq.network/effects?order=desc&cursor=1557363731492865-1"
          },
          "precedes": {
            "href": "https://orbitr-testnet.metriq.network/effects?order=asc&cursor=1557363731492865-1"
          }
        },
      ...
      },
      {
        "_links": {
          ...
          "succeeds": {
            "href": "https://orbitr-testnet.metriq.network/effects?order=desc&cursor=1557363731492865-3"
          },
          "precedes": {
            "href": "https://orbitr-testnet.metriq.network/effects?order=asc&cursor=1557363731492865-3"
          }
        },
	  ...
	  "records": [
		{
		  "_links": {
			"operation": {
			  "href": "https://orbitr-testnet.metriq.network/operations/249108107265"
			},
			"succeeds": {
			  "href": "https://orbitr-testnet.metriq.network/effects?order=desc\u0026cursor=249108107265-1"
			},
			"precedes": {
			  "href": "https://orbitr-testnet.metriq.network/effects?order=asc\u0026cursor=249108107265-1"
			}
		  },
	  ...
	  "records": [
		{
		  "_links": {
			"operation": {
			  "href": "https://orbitr-testnet.metriq.network/operations/224209713045979100"
			},
			"succeeds": {
			  "href": "https://orbitr-testnet.metriq.network/effects?order=desc&cursor=224209713045979100-3"
			},
			"precedes": {
			  "href": "https://orbitr-testnet.metriq.network/effects?order=asc&cursor=224209713045979100-3"
			}
		  },
...
var emptyEffectsPage = `{
  "_links": {
    ...
    "prev": {
      "href": "https://orbitr-testnet.metriq.network/accounts/GCDIZFWLOTBWHTPODXCBH6XNXPFMSQFRVIDRP3JLEKQZN66G7NF3ANOD/effects?cursor=1557363731492865-3&limit=10&order=desc"
    }
  },
  "_embedded": {
    "records": []
