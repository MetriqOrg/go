# Get state from gravity DB, colums match CSV printer
...
echo "Fetching accounts from gravity DB..."
...
echo "Fetching accountdata from gravity DB..."
...
echo "Fetching offers from gravity DB..."
...
echo "Fetching trustlines from gravity DB..."
...
echo "Fetching claimable balances from gravity DB..."
...
echo "Fetching liquidity pools from gravity DB..."
